...
Scenario: nieuwe events van een abonnee
    Als de consumer de request 'GET /abonnees/123456789/kadastraalonroerendezaakevents' stuurt naar de events API
...
Scenario: nieuwe events binnen een topic van een abonnee
    Als de consumer de request 'GET /abonnees/123456789/topics/0344/kadastraalonroerendezaakevents' stuurt naar de events API
...
Scenario: met kadastraal onroerende zaak identificatie en vanaf en tot een tijdstip
    ...
    Dan bevat de response de kadastraal onroerende zaak events gekoppeld aan kadastraalonroerendezaakidentificati 123456 en vanaf 2020-01-01T00:00:00 tot 2020-02-01T00:00:00
