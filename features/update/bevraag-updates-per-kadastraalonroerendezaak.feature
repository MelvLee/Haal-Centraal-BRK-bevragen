...
Functionaliteit: BRK Wijzigingen API
    ...
    Ik wil bij elke wijziging de gehele Kadastraal Onroerende Zaak inclusief alle (sub)resource inclusief de niet-gewijzigde kenmerken kunnen opvragen
...
Scenario: Nieuw zakelijk gerechtigde
    ...
    Dan bevat de response de volgende wijziging gegevensgroep
    | kadastraalobjectidentificatie | type                     | mutatiedatum |
    | 56789012                      | kadastraalonroerendezaak | 2020-02-10   |
